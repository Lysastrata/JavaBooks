package com.tali.books.conrollers;
...
import com.tali.books.services.BookService;
...
public class Books {
    ...
    public String updateBook(@Valid @ModelAttribute("book") Book book, BindingResult result, @PathVariable("id") int id) {
        if (result.hasErrors()) {
            return "editBook.jsp";
        }else{
